...
class AcademicCrawler(BaseCrawler):
    ...
    def __init__(self, output_dir: str = None):
        ...
        self.config = specific_config.ACADEMIC
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        """
        print("=" * 60)
        print(f"开始运行学术论文文献爬虫")
        print("=" * 60)
        
        # 这里应该是实际的爬取逻辑
        # 为了演示，我们返回模拟数据
        
        print(f"正在爬取知网、万方、维普数据...")
        ...
        for i in range(5):
            data_item = {
                "id": i + 1,
                "title": f"academic数据示例 {i+1}",
                "description": f"这是从知网、万方、维普爬取的academic数据示例",
                "platform": "academic",
